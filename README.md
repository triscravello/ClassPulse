...
- Quick action buttons for fast behavior logging
...
2. Dashboard – Add classes and view overall statistics.
3. Classroom View – Manage students, log behavior, and use quick actions.
